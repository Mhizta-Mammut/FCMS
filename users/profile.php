...
<div class="col-sm-4">
<input type="text" name="regdate" required="required" value="<?php echo date("g:ia - d/m/Y", htmlentities($row['regDate']))?>" class="form-control" readonly>
 </div>
</div>
